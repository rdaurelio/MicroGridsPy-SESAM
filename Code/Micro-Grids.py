...
from Plots import DispatchPlot, DispatchPlot1, DispatchPlot2, DispatchPlot3,IcePlot,IcePlot1,IcePlot2,IcePlot3, CashFlowPlot, SizePlot
...
Renewable_Penetration = 0.0        # Fraction of electricity produced by renewable sources. Number from 0 to 1.
Battery_Independence  = 0           # Number of days of battery independence
Tank_Indepedence = 0

#%% Processing
Model_Creation(model, Renewable_Penetration, Battery_Independence,Tank_Indepedence) # Creation of the Sets, parameters and variables.
...
PlotDate1 = '01/04/2022 00:00:00'    # Month-Day-Year. If devoid of meaning: Day-Month-Year
...
PlotDate2 = '01/08/2022 00:00:00'    # Month-Day-Year. If devoid of meaning: Day-Month-Year
...
PlotDate3 = '01/10/2022 00:00:00'    # Month-Day-Year. If devoid of meaning: Day-Month-Year
...
IcePlot(instance,TimeSeries,PlotScenario,PlotDate,PlotTime,PlotResolution,PlotFormat)
IcePlot1(instance,TimeSeries,PlotScenario1,PlotDate1,PlotTime1,PlotResolution1,PlotFormat1)
IcePlot2(instance,TimeSeries,PlotScenario2,PlotDate2,PlotTime2,PlotResolution2,PlotFormat2)
IcePlot3(instance,TimeSeries,PlotScenario3,PlotDate3,PlotTime3,PlotResolution3,PlotFormat3)
...
elapsed = end - start
print('\n\nModel run com plete (overall time: ',round(elapsed,0),'s,',round(elapsed/60,1),' m)\n')
